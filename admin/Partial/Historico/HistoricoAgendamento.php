...
<div class="content">
    ...
    Profissional: <b>
        <?= Valida::Resumi($profissional->getCoPessoa()->getNoPessoa(), 30); ?></b></br>
    Servico: <b>
        <?= $servico->getNoServico(); ?></b></br>
    ...
    //                                ?>
    <!--                                <td>-->
    <? //= Valida::Resumi($profissional->getCoPessoa()->getNoPessoa(), 25); ?><!--</td>-->
    <!--                            --><?php //}
    ...
    //                        } ?>
    <!--                        <td>-->
    <? //= StatusAtendimentoEnum::$descricao[$statusServico2->getStStatus()]; ?><!--</td>-->
    <!--                    --><?php //}
    //                }
    //            } ?>
    <!--        </tr>-->
